...
export default defineConfig({
  ...
  description: '面向大厂 AI Agent 开发工程师的 84 天学习路线、代码实验、简历项目和面试题库',
  base,
  lastUpdated: true,
  cleanUrls: true,
  head: [
    ['meta', { name: 'theme-color', content: '#2563eb' }],
    ['meta', { name: 'apple-mobile-web-app-title', content: 'AI Agent Roadmap' }]
  ],
  themeConfig: {
    logo: '/logo.svg',
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: '01. Agent 心智模型', link: '/lessons/01-agent-mental-model' },
          { text: '02. LLM API 与 Prompt', link: '/lessons/02-llm-api-and-prompt' },
          { text: '03. RAG 从零到可用', link: '/lessons/03-rag-from-zero' },
          { text: '04. Tool Calling 与 MCP', link: '/lessons/04-tool-calling-and-mcp' },
          { text: '05. Agent 核心模式', link: '/lessons/05-agent-patterns' },
          { text: '06. 评测、观测和生产化', link: '/lessons/06-evaluation-observability-production' }
        ]
      },
      {
        text: '代码实验',
        ...
        items: [
          ...
          { text: 'Lab 01：最小 LLM 服务', link: '/labs/lab01_minimal_llm_service/' },
          { text: 'Lab 02：手写 RAG', link: '/labs/lab02_rag_from_scratch/' },
          { text: 'Lab 03：Tool Calling Agent', link: '/labs/lab03_tool_calling_agent/' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '企业经营数据分析 Agent', link: '/projects/enterprise-data-analysis-agent' },
          { text: 'AI Coding / DevOps Agent', link: '/projects/coding-devops-agent' }
        ]
      },
      {
        text: '面试准备',
        ...
        items: [
          ...
          { text: 'Agent / RAG 高频题', link: '/interview/agent-rag-questions' },
